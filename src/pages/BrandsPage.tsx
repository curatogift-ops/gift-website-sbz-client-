...
const BRANDS: Brand[] = [
  { name: 'Amazon Pay Gift Card', image: '/images/brands/imageye___-_imgi_100_f25939_7f99461f862e447a866cdc45d9194707~mv2.png', letter: 'A', tags: ['top', 'popular'] },
  ...
  { name: 'Boss Watches', image: '/images/brands/imageye___-_imgi_61_f25939_758f5155520d4631b0bfdb148278e926~mv2.png', letter: 'B', tags: ['top'] },
  ...
  { name: 'Case Construction', image: '', letter: 'C', tags: ['new'] },
  { name: 'Cup-Ji', image: '', letter: 'C', tags: ['new'] },
  { name: 'Deep Roots', image: '/images/brands/imageye___-_imgi_66_Deep-Roots-Farms-Logo.png', letter: 'D', tags: ['new'] },
  { name: 'Eat Anytime', image: '', letter: 'E', tags: ['new'] },
  { name: 'Echolac', image: '', letter: 'E', tags: ['new'] },
  ...
  { name: 'Glasafe', image: '', letter: 'G', tags: ['new'] },
  { name: 'Goodwish', image: '', letter: 'G', tags: ['new'] },
  { name: 'Goodwyn Tea', image: '/images/brands/imageye___-_imgi_72_images (1).png', letter: 'G', tags: ['new'] },
  { name: 'Mathey-Tissot', image: '', letter: 'M', tags: ['new'] },
  ...
  { name: 'Movado', image: '', letter: 'M', tags: ['new'] },
  { name: 'Nasher Miles', image: '', letter: 'N', tags: ['new'] },
  { name: 'Nedis', image: '/images/brands/imageye___-_imgi_82_f25939_78801ef87c674aed8c45f703911479fb~mv2.png', letter: 'N', tags: ['new'] },
  { name: 'Nike Perfumes', image: '/images/brands/imageye___-_imgi_81_f25939_669985f3a21849aa9b3582eb8bb02506~mv2.jpg', letter: 'N', tags: ['top'] },
  { name: 'Nothing', image: '', letter: 'N', tags: ['new'] },
  { name: 'Nuuk', image: '', letter: 'N', tags: ['new'] },
  { name: 'OnePlus', image: '/images/brands/imageye___-_imgi_84_f25939_ee8429bd385146b4b81683716af2c425~mv2.png', letter: 'O', tags: ['top'] },
  { name: 'Pebble', image: '', letter: 'P', tags: ['new'] },
  { name: 'Portronics', image: '', letter: 'P', tags: ['popular'] },
  { name: 'Puretive Botanics', image: '', letter: 'P', tags: ['new'] },
  { name: 'Rare Rabbit', image: '', letter: 'R', tags: ['new'] },
  { name: 'Rico Home Appliances', image: '', letter: 'R', tags: ['new'] },
  { name: 'Samsung', image: '/images/brands/imageye___-_imgi_90_f25939_6370213bb3fb402fb8d2de0de2da791d~mv2.png', letter: 'S', tags: ['top'] },
  { name: 'Scuderia Ferrari', image: '', letter: 'S', tags: ['new'] },
  { name: 'Sheaffer', image: '', letter: 'S', tags: ['new'] },
  { name: 'Snackible', image: '', letter: 'S', tags: ['new'] },
  { name: 'Swiss Military (Swiss Cross)', image: '/images/brands/imageye___-_imgi_59_f25939_05b0deacf0c54c72982685b4ce2c1fba~mv2.webp', letter: 'S', tags: ['top', 'new'] },
  { name: 'Targus', image: '', letter: 'T', tags: ['new'] },
  { name: 'Toreto', image: '', letter: 'T', tags: ['new'] },
  { name: 'Tucano', image: '', letter: 'T', tags: ['new'] },
  { name: 'Urban Gear', image: '', letter: 'U', tags: ['new'] },
  { name: 'Versalis', image: '', letter: 'V', tags: ['new'] },
  { name: 'Waterman Paris', image: '', letter: 'W', tags: ['new'] },
  { name: 'Weber', image: '', letter: 'W', tags: ['new'] },
  { name: 'Xech', image: '', letter: 'X', tags: ['new'] },
